...
import { categoriasGaleria, type FotoGaleria } from "@/lib/galeria";
...
type Props = {
  initialFotos: FotoGaleria[];
};

export function GaleriaPageClient({ initialFotos }: Props) {
  const [filtro, setFiltro] = useState<Filtro>("Todas");
  const [fotosBase, setFotosBase] = useState<FotoGaleria[]>(initialFotos);
