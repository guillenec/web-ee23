  ...
  return (
    <main className="page-enter bg-app px-5 py-10 sm:px-8">
      <div className="mx-auto max-w-6xl space-y-8">
        <div data-reveal>
          <section className="surface-hover grid gap-6 rounded-3xl border border-brand-dark/10 bg-surface p-6 sm:grid-cols-2 sm:p-8">
        ...
        <section data-reveal className="grid gap-5 md:grid-cols-3">
          <article className="surface-hover rounded-2xl border border-brand-dark/10 bg-surface p-5">
        ...
        <div data-reveal>
          <section className="surface-hover rounded-3xl border border-brand-dark/10 bg-surface p-6 sm:p-8">
